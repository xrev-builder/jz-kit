...
cols=['rank','player','pos','team_26','age','bye','ecr_ovr','ecr_pos','g_25','ppgA_25','ppgB_25','top6A_25','floorA_25','tgt_25','tgt_share_25','car_25','ru100_25','re100_25','pass_td_25','p300_25','ru_yds_25','snap_pct_25','espn_adp','note']
esp=pd.read_csv(O+'espn_adp_est.csv')[['player','espn_adp']]
A=build(A_ORDER).merge(esp,on='player',how='left'); B=build(B_ORDER).merge(esp,on='player',how='left')
