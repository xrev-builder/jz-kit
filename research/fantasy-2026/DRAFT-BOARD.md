...
1. This room, not the ESPN average, is the model: two years of the same ten drafters (2024 and 2025 boards transcribed, matched to that August's expert consensus). Measured habits: running backs ranked 12-60 by consensus go about 10 picks early (Henry 23 to 11, Jacobs 30 to 18, Irving 30 to 19, Taylor 32 to 20, Walker 44 to 23, Cook 48 to 27, Hampton 50 to 34), receivers go at consensus, tight ends about 8 picks late (McBride 21 to 31), and the QB run comes in rounds 3-5. ESPN's own sheet is also WR-heavy early, so the receivers are not going to slide either.
...
| R2 | 17 | Chase Brown or Jeanty if either is there (38% / 24%); else Kyren Williams (76%), Javonte Williams, Breece Hall; or McBride (82%), Collins, Pickens, London if the RB left is not one you want | Olave, A.J. Brown; Allen if the room already took two QBs | Measured room: RBs ranked 12-60 go ~10 picks early, WRs at consensus, McBride late. Take the scarcer piece that is actually there; the RB2 window is 37-44 |
| R3 | 24 | Josh Allen if there (66%); McBride (58%) if you did not take him; else Pickens (79%), Olave (70%), Collins, A.J. Brown, Kyren (50%) | Nabers with good Wk-1 news, Garrett Wilson | Allen at 24 is the only QB worth a round-3 pick; Billy takes him at the turn if you do not |
| R4 | 37 | Maye (54%) if you did not take Allen; else Judkins (50%), Irving (66%), Swift (70%, clean report only), Montgomery (73%), Skattebo (84%) as the RB2; or McMillan (73%), Warren (94%), DeVonta Smith, Flowers | Egbuka, McConkey; Judkins/Montgomery if the RB2 tier is thinning | The QB run was picks 30-47 last year: Maye is a 37 decision, never a 44 decision. The room's RB run is over by here, so RB2 value starts at 37 |
