...
base=['Drake Maye','Chase Brown','Kyren Williams','Jadarian Price','Rico Dowdle','Puka Nacua','George Pickens','Carnell Tate','Harold Fannin Jr.',"Wan'Dale Robinson",'Kyle Pitts Sr.','Jayden Reed']
fill=['Samaje Perine','Los Angeles Chargers','KC Concepcion']
ro=base+[cand]+[f for f in fill if f!=cand][:2]
