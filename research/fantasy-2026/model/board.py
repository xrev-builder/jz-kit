...
"Ja'Marr Chase":"20.3 ppg in 2025 with Burrow hurt most of the year; 24.5 ppg in 2024. 185 tgt, 32% share. Hyperextended knee Aug 25, DNP Sep 1-2 'out of an abundance of caution'; Taylor: could play if there were a game tomorrow. No discount.",
'Puka Nacua':"24.4 ppg (WR1), 166 tgt in 16 g, six 100-yd games. Psoas soreness resolved, practicing since Aug 30. NFL conduct review still open as of Sep 3: not suspended, not on the exempt list, and the league has no deadline, so a 1-6 game ruling can land any day. Priced with a 35% chance of a 3-game absence.",
...
'Christian McCaffrey':"25.2 ppg (RB1 overall), 129 tgt, 311 car. Age 30.3 with 450 touches incl. playoffs; calf tightness in camp resolved, full participant, 'on track' for Sep 10. Bilateral Achilles tendinitis in 2024. Age cliff plus the soft-tissue file are the knocks; the usage model still has him RB4.",
...
'A.J. Brown':"15.2 ppg, 30% share, best-6 avg 25.5. Traded to NE: Drake Maye (31 TD) and Diggs's 1,013 vacated yards. Age 29. Playing through a dislocated thumb (Aug 31) after a camp hamstring; three hamstrings in three years, so 0.5 extra expected games missed.",
...
'Rashee Rice':"19.0 ppg in 8 g, 9.8 tgt/g, 29% share. May 2026 arthroscopic cleanup on the surgically repaired knee; back in 11-on-11 late August. Mahomes back from ACL/LCL; Bieniemy OC. Has not played more than 8 games since 2023.",
...
'Saquon Barkley':"15.1 ppg in 2025 (24.6 in 2024), 280 car, 50 tgt, 4.07 YPC. Age 29.6 = RB cliff zone (top-20 RB seasons halve at 29). Left foot/ankle checked by trainers at practice this week, stayed on the field, no diagnosis announced.",
'Ashton Jeanty':"14.8 ppg, 266 car, 73 tgt, best-6 avg 24.8. Low-ankle sprain Aug 23 (not high-ankle, not IR); side work Sep 1, Kubiak 'yes' when asked if optimistic for Wk 1 (Sep 2). Cousins/Kubiak upgrade over 2025. Mike Washington Jr. is the hedge.",
...
'Kenneth Walker III':"11.6 ppg in SEA committee (RB28); now KC's clear lead back (Reid RB1s average 250+ touches). Foot soreness/ankle swelling from a shoe issue, DNP twice, Reid not concerned, opener not until Sep 14. Calf/ankle/oblique history: +0.5 expected games missed.",
'Malik Nabers':"18.5 ppg over 15 games in 2024 (the 2025 four-game sample is one 39-pt game). ACL+meniscus Oct 2025: shed the no-contact jersey Aug 31, Harbaugh 'reasonable to assume' Wk 1, but he left Wed Sep 2 practice ~20 min early with trainers (team says no injury). WR ACL year-1 production loss is the largest in the literature (age 23 helps): priced at 90% of his healthy line. Dart at QB. Karabell has him on ESPN's do-not-draft list, so he may fall.",
...
'Tee Higgins':"14.2 ppg, 11 TD on 98 tgt (11.2% TD rate; league ~5.5%, so ~5 TD and ~12 ppg is the regressed line). Heel contusion, DNP Sep 2 but ran hills, expected Wk 1. Hamstring/quad history. ESPN price ~55: fine at 42-59, not at 30.",
...
'Emeka Egbuka':"11.8 ppg, 127 tgt, 24% share as rookie; hot Wks 1-5 then faded. Toe sprain Aug 12, still day-to-day, Bowles 'hopeful' for Wk 1, local beat says 'lingering'. Evans gone (SF); Godwin (30, off two ankle surgeries) is the WR2.",
...
'Cam Skattebo':"16.0 ppg in 8 g before the open tib/fib fracture and ankle dislocation (Oct 2025). Full camp participant, played the preseason opener, says 'ready to go'; Harbaugh: not yet 100% twitchy. Listed starter in a run-heavy offense. Priced at 90% of his healthy line.",
'Jeremiyah Love':"Rookie #3 overall (R1 RBs hit top-24 71% of the time). High-ankle sprain Aug 13, no surgery; 'about 50/50' for Wk 1 (Sep 2). Literature: early returners from high-ankle sprains rarely regain form for weeks. Team chart lists Allgeier first. ESPN drafters take him ~25: do not pay that.",
...
'Jadarian Price':"Rookie R1 (#32), SEA starter: Macdonald 'really confident in him going into Week 1'; Walker gone, Charbonnet PUP (out 4+, likely Wk 7). Zero preseason snaps; Holani in tandem. ECR 73 = discount for a lead back on a Super Bowl offense.",
...
"D'Andre Swift":"14.8 ppg, 223 car, 48 tgt in the Ben Johnson offense. Left Thu Sep 3 practice holding his midsection after a goal-line carry, no diagnosis; Monangai (knee) is week-to-week too. Fade until the Sep 9 report; Roschon Johnson is the contingency.",
...
'Rome Odunze':"12.4 ppg in 12 g, 24% share, WR11 ppg Wks 1-8; listed WR1 outside with Moore gone. Left Thu Sep 3 practice early (right leg, walked off, no diagnosis); 2025 foot stress fracture. First official report Wed Sep 9: draft a round later than the sheet and hedge.",
...
'Mike Evans':"10.8 ppg in 8 g, age 33. Signed with SF (Purdy, Shanahan); Pearsall done for the season, Deebo WR2. Camp groin kept him out a week, back Sep 2 and expected Sep 10. Three hamstrings plus a groin: chronic soft-tissue flag, +1 expected game missed.",
...
'Tucker Kraft':"15.0 ppg in 8 g, but two spike games (25.9, 34.8) were 51% of it; the other six averaged 9.9. ACL Nov 2: off PUP July 31, full joint-practice contact, 'full-go' Wk 1 per CBS, likely on a snap count early. TE5-7 with TE1 weeks.",
...
'Patrick Mahomes II':"20.4/23.8 ppg in 14 g, 422 rush yds. ACL/LCL Dec 14; full camp participant, no preseason snaps, 'on track' for Mon Sep 14 (exactly 9 months post-op). QB ACL literature: 92% return, no production loss. Rice/Worthy/Kelce; Bieniemy back.",
...
'Sam LaPorta':"11.9 ppg in 9 g (2025, lumbar disc surgery ~Wk 10); cleared for camp, then a hip injury in late August and Campbell 'I don't know' on Wk 1. Back literature: stats hold after discectomy, availability does not. TE8-10 with a 1.5-game haircut.",
'George Kittle':"14.8 ppg in 11 g; Achilles tear Jan 11, activated from PUP, flew to Australia with the team Sep 2 and is 'trending' to play Wk 1. Age 33. Achilles literature: TE return rate is the best of any position (71%) but only 27% of players get back to their prior level in year 1, so he is priced at 85% of his healthy line (TE6-8), not TE1.",
'Tony Pollard':"11.5 ppg, 242 car, three 100-yd games; contract year, trade candidate; Spears/Singleton behind.",
'Josh Jacobs':"15.8 ppg, 234 car. Commissioner's Exempt List (Aug 30), 'not in line to play Sunday', no timeline, 6-game suspension still possible on top. ESPN tags exempt players SSPD, not IR-eligible: he burns a bench slot. Someone in the room will take him off the printed sheet around 55-70; do not.",
...
'Daniel Jones':"17.4/20.6 ppg in 13 g before the Achilles (Dec 2025); says 100%, took every first-team rep in camp, starting Sep 13. Achilles year-1 haircut applies even to QBs. Taylor/Warren/Pierce/Downs/Allen. ECR 148 = free QB12-14.",
...
'Kyle Monangai':"9.0 ppg, 169 car, 5 TD as rookie; hyperextended knee Aug 16, week-to-week per Johnson (Sep 1), Wk 1 in serious question. Swift handcuff once healthy, and Swift left Thursday's practice hurt: the CHI backfield is unresolved.",
...
'Jordyn Tyson':"Rookie #8 overall (NO). IR/designated to return Aug 30, hamstring: 4th hamstring in 4 years (38% any-season recurrence in the literature). Earliest Wk 5, realistic Wk 7-8. IR-slot stash only.",
'James Conner':"IR, designated to return (ankle dislocation Sep 2025, ~11 months post-op); out at least Weeks 1-4, earliest Wk 5 Oct 11; behind Love/Allgeier when back. IR-slot stash at best.",
...
A_ORDER="""Jahmyr Gibbs|Ja'Marr Chase|Bijan Robinson|Puka Nacua|Jaxon Smith-Njigba|Amon-Ra St. Brown|Christian McCaffrey|Jonathan Taylor|James Cook III|Chase Brown|Trey McBride|De'Von Achane|George Pickens|Drake London|CeeDee Lamb|Justin Jefferson|Kyren Williams|Chris Olave|Nico Collins|Ashton Jeanty|Josh Allen|Brock Bowers|A.J. Brown|Rashee Rice|Zay Flowers|Derrick Henry|Omarion Hampton|Kenneth Walker III|DeVonta Smith|Tetairoa McMillan|Javonte Williams|Jameson Williams|Tyler Warren|Emeka Egbuka|Saquon Barkley|Colston Loveland|Tee Higgins|Travis Etienne Jr.|Drake Maye|Lamar Jackson|Ladd McConkey|Breece Hall|Jaylen Waddle|TreVeyon Henderson|Kyle Pitts Sr.|Harold Fannin Jr.|Bucky Irving|D'Andre Swift|Jalen Hurts|Quinshon Judkins|Garrett Wilson|Wan'Dale Robinson|Davante Adams|Caleb Williams|Parker Washington|DJ Moore|Rico Dowdle|DK Metcalf|Cam Skattebo|Tucker Kraft|Luther Burden III|Rome Odunze|Trevor Lawrence|Quentin Johnston|Michael Wilson|Joe Burrow|Alec Pierce|Courtland Sutton|RJ Harvey|Michael Pittman Jr.|Rhamondre Stevenson|Travis Kelce|Jaylen Warren|Brian Thomas Jr.|Jadarian Price|Carnell Tate|Jeremiyah Love|Dak Prescott|Justin Herbert|Bo Nix|Terry McLaurin|Christian Watson|Dallas Goedert|Malik Nabers|Marvin Harrison Jr.|Jake Ferguson|Sam LaPorta|Jonathon Brooks|Makai Lemon|Jayden Daniels|Jordan Addison|MarShawn Lloyd|Brock Purdy|David Montgomery|Matthew Stafford|Jakobi Meyers|Jared Goff|Kenny Gainwell|Juwan Johnson|Stefon Diggs|Hunter Henry|Khalil Shakir|George Kittle|Josh Downs|Romeo Doubs|Patrick Mahomes II|Mike Evans|KC Concepcion|J.K. Dobbins|Mark Andrews|Tony Pollard|Dalton Kincaid|Dalton Schultz|Bhayshul Tuten|De'Zhaun Stribling|Jaxson Dart|Baker Mayfield|Xavier Worthy|Oronde Gadsden II|Jacory Croskey-Merritt|Jordan Watkins|Brenton Strange|Troy Franklin|Kyler Murray|Chig Okonkwo|Kyle Monangai|Tre Tucker|AJ Barner|Xavier Restrepo|Jauan Jennings|Jayden Reed|Jalen Royals|Kayshon Boutte|Rashid Shaheed|Deebo Samuel Sr.|Hollywood Brown|Woody Marks|Keon Coleman|Chris Godwin Jr.|Sam Darnold|Jalen Coker|CJ Daniels|Ja'Kobi Lane|Elijah Sarratt|Chris Blair|Phil Mafah|Rachaad White|Cade Otton|Tyler Shough|Jacob Cowing|Jordyn Tyson|James Conner|Zach Charbonnet|Isiah Pacheco|Josh Jacobs|Tank Dell|Los Angeles Chargers|Cleveland Browns|Seattle Seahawks|Minnesota Vikings|Chicago Bears|Philadelphia Eagles|Pittsburgh Steelers|Detroit Lions|Houston Texans|Denver Broncos"""

B_ORDER="""Jahmyr Gibbs|Ja'Marr Chase|Bijan Robinson|Puka Nacua|Jaxon Smith-Njigba|Amon-Ra St. Brown|Christian McCaffrey|Jonathan Taylor|James Cook III|Trey McBride|Chase Brown|De'Von Achane|George Pickens|CeeDee Lamb|Justin Jefferson|Drake London|Kyren Williams|Josh Allen|Nico Collins|Chris Olave|Rashee Rice|A.J. Brown|Ashton Jeanty|Brock Bowers|Zay Flowers|Jeremiyah Love|Omarion Hampton|DeVonta Smith|Derrick Henry|Kenneth Walker III|Tetairoa McMillan|Tyler Warren|Javonte Williams|Drake Maye|Jameson Williams|Lamar Jackson|Emeka Egbuka|Tee Higgins|Colston Loveland|Travis Etienne Jr.|Saquon Barkley|Ladd McConkey|Jaylen Waddle|Jadarian Price|Breece Hall|Harold Fannin Jr.|TreVeyon Henderson|Kyle Pitts Sr.|Bucky Irving|Carnell Tate|D'Andre Swift|Garrett Wilson|Jalen Hurts|Quinshon Judkins|Davante Adams|Caleb Williams|Wan'Dale Robinson|Joe Burrow|Parker Washington|Trevor Lawrence|DK Metcalf|DJ Moore|Quentin Johnston|Luther Burden III|Cam Skattebo|Rome Odunze|Dak Prescott|Tucker Kraft|Rico Dowdle|Courtland Sutton|Alec Pierce|Michael Pittman Jr.|Michael Wilson|Brian Thomas Jr.|Travis Kelce|RJ Harvey|Jaylen Warren|Terry McLaurin|Bo Nix|Rhamondre Stevenson|Marvin Harrison Jr.|Malik Nabers|Christian Watson|Justin Herbert|Dallas Goedert|Jake Ferguson|Makai Lemon|Jakobi Meyers|Sam LaPorta|Matthew Stafford|Jonathon Brooks|Jordan Addison|MarShawn Lloyd|David Montgomery|Juwan Johnson|Jared Goff|Brock Purdy|Stefon Diggs|Josh Downs|Khalil Shakir|Kenny Gainwell|Jayden Daniels|Hunter Henry|Romeo Doubs|KC Concepcion|Mike Evans|George Kittle|J.K. Dobbins|Dalton Kincaid|Mark Andrews|Bhayshul Tuten|Tony Pollard|Dalton Schultz|Patrick Mahomes II|De'Zhaun Stribling|Xavier Worthy|Baker Mayfield|Brenton Strange|Jordan Watkins|Oronde Gadsden II|Chig Okonkwo|Xavier Restrepo|Jauan Jennings|Troy Franklin|Jacory Croskey-Merritt|AJ Barner|Kyle Monangai|Jayden Reed|Jaxson Dart|Tre Tucker|Jalen Royals|Rashid Shaheed|Kayshon Boutte|Hollywood Brown|Deebo Samuel Sr.|Keon Coleman|Jalen Coker|CJ Daniels|Elijah Sarratt|Ja'Kobi Lane|Chris Godwin Jr.|Kyler Murray|Woody Marks|Phil Mafah|Chris Blair|Skyler Bell|Colbie Young|Jacob Cowing|Brandon Aiyuk|Cyrus Allen|Jordyn Tyson|James Conner|Zach Charbonnet|Isiah Pacheco|Josh Jacobs|Tank Dell|Los Angeles Chargers|Cleveland Browns|Seattle Seahawks|Minnesota Vikings|Chicago Bears|Philadelphia Eagles|Pittsburgh Steelers|Detroit Lions|Houston Texans|Denver Broncos"""
...
emx=pd.read_csv(O+'model_scores_A.csv')[['player','exp_missed']]  # model exp_missed: bucket + 2025 report flags + news + lingering-injury literature
